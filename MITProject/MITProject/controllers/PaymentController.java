...
import tn.MITProject.entities.Response;
	...
	return payment;
		...
		@GetMapping("/remainingamount{Contract-id}")
		@ResponseBody
		public float viewremainingamount (@PathVariable("ContractID") Long ContractID) {
		return paymentService.viewremainingamount(ContractID);
		}
		...
		@GetMapping("/getPaymentByContrat/{Contract-id}")
		@ResponseBody
