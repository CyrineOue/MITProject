	 ...
	 private List<Payment> listPayments;
	    ...
	    private void writeTableHeader(PdfPTable table) {
	     ...
	     //   cell.setPhrase(new Phrase("Payment_ID", font));
	       ...
	       // table.addCell(cell);
	      cell.setPhrase(new Phrase("Number of installments", font));
	       table.addCell(cell);
	    ...
	    private void writeTableData(PdfPTable table) {
	    	...
	    	for (Payment payment : listPayments) {
	    		 ...
	    		 table.addCell(String.valueOf(payment.getCopayment().getInstallmentsNB()));
	    		 table.addCell(String.valueOf(payment.getCopayment().getIDClientC()));
